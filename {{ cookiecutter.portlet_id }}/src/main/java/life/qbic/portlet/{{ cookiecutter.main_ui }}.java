...
public class {{ cookiecutter.main_ui }} extends QBiCPortletUI {
    ...
    protected Layout getPortletContent(final VaadinRequest request) {
        ...
        builder.append("<hr width='100%'/><br/>Enter some text in the text field, select a log level and then click on the button to see <i>log4j2</i> in action (configuration taken from: <font face='monospace'>src/resources/log4j2.xml</font>).");
