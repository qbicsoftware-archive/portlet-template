...
public class {{ cookiecutter.main_ui }} extends QBiCPortletUI {
    ...
    private Layout REMOVE_THIS_METHOD_AND_DO_YOUR_OWN_THING_COMMA_PLEASE(final VaadinRequest request) {
        ...
        final StringBuilder builder = new StringBuilder("<h2>This is just a sample <i>sanity check</i> test portlet.</h2>");
        ...
        final Label logLabel = new Label(builder.toString(), ContentMode.HTML);
    ...
    private boolean isOpenBISWorking(final String dataSourceUser, final String dataSourcePassword, final String dataSourceUrl) {
        ...
        try {
            final OpenBisClient openBisClient = new OpenBisClient(dataSourceUser, dataSourcePassword, dataSourceUrl);
            openBisClient.login();
